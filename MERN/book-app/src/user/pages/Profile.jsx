    ...
    <>
      ...
      {/* book status */}
      {
        ...
        <div className='p-10 my-20 shadow rounded'>
          ...
          {userBooks?.length > 0 ? userBooks?.map(book => (<div key={book?._id} className='p-5 rounded mt-4 bg-gray-100'>
            <div className='md:grid grid-cols-[3fr_1fr]'>
              <div className='px-4'>
                ...
                <div className='flex mt-3'>
                  ...
                  {book?.status == 'pending' ?
                    <img width={'80px'} height={'80px'} src="https://t3.ftcdn.net/jpg/01/71/60/84/360_F_171608484_figMqbjvhS7T8uCpPZDErlLI4HeWklYG.jpg" alt="pending" /> :
